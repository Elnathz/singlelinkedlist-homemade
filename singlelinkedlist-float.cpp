...
class singleLinkedList
{
    ...
    void insertAfter(float tujuanNode, float value)
    {
        nodePntr current = head;
        while(current != nullptr)
        {
    ...
    void deleteAfter(float tujuanNode)
    {
        nodePntr current = head;
        while(current != nullptr)
        {
...
// procedure
void menuTampilan();
void menuInsertFirst(float value);
void menuInsertAfter(float value, float tujuanNode);
void menuInsertLast(float value);
void menuDeleteHead();
void menuDeleteAfter(float tujuanNode);
void menuDeleteLast();
void menuPrintList();
